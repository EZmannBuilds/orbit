 ...
 */
export const SERVICE_ROLE_PURPOSES = Object.freeze(["account-deletion"]);
...
export function serviceRoleVerdict(purpose, env = process.env, context = {}) {
  ...
  // Exact match, case-sensitively. A value this consequential should be copied,
  // not remembered; an approximate match is indistinguishable from a guess.
  if (declared !== purpose) {
