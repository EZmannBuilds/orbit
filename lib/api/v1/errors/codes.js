...
export const ERROR_CODES = Object.freeze({
  ...
  CONFIRMATION_REQUIRED: { status: 400, message: "This action needs an explicit confirmation." },
  DELETION_INCOMPLETE: { status: 500, message: "The account was not fully removed. Please try again." },
