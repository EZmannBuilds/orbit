...
export const RATE_LIMITS = Object.freeze({
  ...
  // Destructive and authenticated. A legitimate person deletes their account
  // once; a tighter budget costs them nothing and blunts anyone hammering the
  // endpoint with stolen tokens.
